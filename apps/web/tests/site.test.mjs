...
const profile = JSON.parse(readFileSync(new URL('home/profile.json', content), 'utf8'));
const posts = JSON.parse(buildBlogIndex(fileURLToPath(new URL('blogs', content))).json);
