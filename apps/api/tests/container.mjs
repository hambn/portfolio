...
import { nodeServices } from '../src/adapters/node.ts';
import { handleRequest } from '../src/app.ts';
import { refreshLinkedIn } from '../src/providers/linkedin.ts';
import { mediaPath } from '@portfolio/shared/media';
...
try {
  ...
  const linkedInHtml = await readFile(
    new URL('./fixtures/linkedin-public.html', import.meta.url),
    'utf8',
  );
