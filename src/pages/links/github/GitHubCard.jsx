  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="gh-style-2"
      >
        <a href={href} target="_blank" rel="noopener noreferrer" className="gh-style-3">
          <svg viewBox="0 0 24 24" fill={GH.text} width={18} height={18} className="gh-style-4">
            <path d={GH_ICON} />
          </svg>
          <span
            style={{
      ...
      <div className={`sc-body ${collapsed ? 'closed' : 'open'}`}>
        ...
        >
          ...
          <a
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.background = GH.greenH;
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.background = GH.green;
            }}
