  ...
  return (
    ...
    >
      ...
      <div className={`sc-body ${collapsed ? 'closed' : 'open'}`}>
        {/* Banner */}
        <div
          style={{ height: '100px', background: LI.banner, position: 'relative', flexShrink: 0 }}
        >
          {banner && !bannerError && (
          ...
          >
            <div style={{ flex: '1 1 220px', minWidth: 0 }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', alignItems: 'center' }}>
                ...
                {connections && (
                  <span style={{ fontSize: '12px', color: LI.blueLt, fontWeight: '600' }}>
                    {connections} connections
                  </span>
                )}
                {followers != null && (
                  <span style={{ fontSize: '12px', color: LI.faint }}>
