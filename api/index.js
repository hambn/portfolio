import { handleTelegram, refreshTelegram } from './telegram.js';
...
export default {
  ...
  async fetch(request, env) {
    ...
    if (pathname.startsWith('/telegram')) return (await handleTelegram(request, env)) ?? json({ error: 'not found' }, 404);
